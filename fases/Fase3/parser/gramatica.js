...
function peg$parse(input, options) {
  ...
  var peg$e34 = peg$otherExpectation("espacios");
  ...
  var peg$f0 = function(inicio, prods) {
  ...
  var peg$f4 = function(label, expr, qty, bloque) {
  ...
  function peg$parseexpresion() {
    ...
    s2 = peg$parse_();
    s3 = peg$parseexpresionSinCodigo();
    if (s3 !== peg$FAILED) {
      s4 = peg$parse_();
      s5 = peg$currPos;
      ...
      s6 = peg$parseBloqueDeCodigo();
      if (s6 === peg$FAILED) {
        s6 = null;
      }
      peg$savedPos = s0;
      s0 = peg$f4(s1, s3, s5, s6);
    } else {
      peg$currPos = s0;
      s0 = peg$FAILED;
    }
  ...
  function peg$parseexpresionSinCodigo() {
    var s0, s1, s2, s3, s4, s5;
  ...
  function peg$parseBloqueDeCodigo() {
    var s0, s1, s2, s3;
  ...
  function peg$parseContenidoCodigo() {
    var s0, s1, s2;

    s0 = peg$currPos;
    s1 = [];
    s2 = peg$parseContenidoCodigoInterno();
    while (s2 !== peg$FAILED) {
      s1.push(s2);
      s2 = peg$parseContenidoCodigoInterno();
    }
  ...
  function peg$parseContenidoCodigoInterno() {
    var s0, s1, s2, s3;
    ...
    if (s1 !== peg$FAILED) {
      s2 = peg$parseComentarioCodigo();
      if (s2 === peg$FAILED) {
        s2 = peg$parseCaracterCodigo();
      }
      if (s2 !== peg$FAILED) {
        s1 = [s1, s2];
        s0 = s1;
    ...
    if (s0 === peg$FAILED) {
      ...
      if (s1 !== peg$FAILED) {
        s2 = [];
        s3 = peg$parseContenidoCodigoInterno();
        while (s3 !== peg$FAILED) {
          s2.push(s3);
          s3 = peg$parseContenidoCodigoInterno();
        }
  ...
  function peg$parseComentarioCodigo() {
    var s0, s1, s2, s3;
  ...
  function peg$parseCaracterCodigo() {
    var s0;
